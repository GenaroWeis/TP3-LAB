...
public class MenuInputProcessor extends BaseInputProcessor{
    ...
    public void renderMenu() {
        ...
        while (!exit) {
            ...
            try {//modificadooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
                switch (choice) {
                    case 1:
            ...
            } catch (TipoCuentaNoSoportadaException e) {//modificadooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
